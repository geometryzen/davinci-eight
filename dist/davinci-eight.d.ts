...
declare module EIGHT {
   ...
   */
  interface ShareableWebGLProgram extends IContextConsumer, FacetVisitor {
    programId: string;
    vertexShader: string;
   ...
   */
  function smartProgram(attributes: { [name: string]: AttribMetaInfo }, uniforms: { [name: string]: UniformMetaInfo }, bindings?: string[]): ShareableWebGLProgram;
  ...
  interface IDrawList extends IContextConsumer, IUnknown {
    ...
    /**
     * Gets a composite that matches the specified test.
     */
    findOne(match: (composite: Composite) => boolean): Composite;

    /**
     * Gets a composite element with the specified name.
     */
    ...
    traverse(callback: (composite: Composite) => void): void;
  }
  ...
  class PerspectiveCamera extends AbstractFacet implements Perspective {
     ...
     */
    material: ShareableWebGLProgram;
    /**
   ...
   *
   */
  class GraphicsProgram implements ShareableWebGLProgram {
   ...
   */
  class Composite extends Shareable implements Composite {
    ...
    constructor(buffers: GraphicsBuffers, program: ShareableWebGLProgram);
    /**
     *
     */
    attachToMonitor(monitor: IContextMonitor): void;
   ...
   *
   */
  interface Arrow extends Composite {
   ...
   *
   */
  interface Box extends Composite {
   ...
   *
   */
  interface Cylinder extends Composite {
   ...
   *
   */
  interface Sphere extends Composite {
  ...
  class RigidBody extends Composite {
    /**
     * The color property.
     */
    color: Color;
