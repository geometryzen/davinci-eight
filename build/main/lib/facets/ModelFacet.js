...
var ModelFacet = /** @class */ (function (_super) {
    ...
    ModelFacet.prototype.setUniforms = function (visitor) {
        this.updateMatrices();
        visitor.matrix4fv(GraphicsProgramSymbols_1.GraphicsProgramSymbols.UNIFORM_MODEL_MATRIX, this._matM.elements, false);
        visitor.matrix3fv(GraphicsProgramSymbols_1.GraphicsProgramSymbols.UNIFORM_NORMAL_MATRIX, this._matN.elements, false);
    };
