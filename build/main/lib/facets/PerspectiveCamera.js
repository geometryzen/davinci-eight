...
var ViewTransform_1 = require("./ViewTransform");
/**
 * <p>
...
var PerspectiveCamera = (function () {
    ...
    function PerspectiveCamera(fov, aspect, near, far) {
        ...
        this.P = new PerspectiveTransform_1.PerspectiveTransform(fov, aspect, near, far);
        this.V = new ViewTransform_1.ViewTransform();
    }
    /**
    ...
    PerspectiveCamera.prototype.imageToWorldCoords = function (imageX, imageY, imageZ) {
        ...
        return Geometric3_1.Geometric3.fromVector(this.V.cameraToWorldCoords(cameraCoords));
    };
    /**
     *
     */
