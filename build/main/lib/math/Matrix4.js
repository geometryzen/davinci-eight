...
var inv4x4_1 = require("../math/inv4x4");
var Lockable_1 = require("../core/Lockable");
var mul4x4_1 = require("../math/mul4x4");
var perspectiveArray_1 = require("../facets/perspectiveArray");
...
var Matrix4 = (function (_super) {
    ...
    Matrix4.prototype.perspective = function (fov, aspect, near, far) {
        perspectiveArray_1.perspectiveArray(fov, aspect, near, far, this.elements);
        return this;
    };
    /**
     * @param axis
    ...
    Matrix4.prototype.mul2 = function (a, b) {
        mul4x4_1.mul4x4(a.elements, b.elements, this.elements);
        return this;
    };
    /**
     *
