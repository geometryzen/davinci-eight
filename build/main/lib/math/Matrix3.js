...
var Matrix3 = (function (_super) {
    ...
    Matrix3.prototype.add = function (rhs) {
        if (this.isLocked()) {
            throw new Lockable_2.TargetLockedError('add');
        }
    ...
    Matrix3.prototype.det = function () {
        return det3x3_1.det3x3(this.elements);
    };
    /**
     * <p>
    ...
    Matrix3.prototype.reflection = function (n) {
        ...
        var ny = mustBeNumber_1.mustBeNumber('n.y', n.y);
        var aa = -2 * nx * ny;
        var xx = 1 - 2 * nx * nx;
        var yy = 1 - 2 * ny * ny;
