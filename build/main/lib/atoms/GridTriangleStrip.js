...
function triangleStripForGrid(uSegments, vSegments, elements) {
    ...
    var uLength = numPostsForFence_1.numPostsForFence(uSegments, false /* open */);
...
var GridTriangleStrip = /** @class */ (function (_super) {
    ...
    function GridTriangleStrip(uSegments, vSegments) {
        var _this = _super.call(this, BeginMode_1.BeginMode.TRIANGLE_STRIP, uSegments, vSegments) || this;
    ...
    GridTriangleStrip.prototype.vertex = function (uIndex, vIndex) {
        ...
        mustBeInteger_1.mustBeInteger('vIndex', vIndex);
...
exports.GridTriangleStrip = GridTriangleStrip;
