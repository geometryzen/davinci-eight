...
function view(X, eye, look, up) {
     ...
     */
    var v = n.cross(u);
    var du = -dotVectorE3_1.dotVectorE3(eye, u);
    var dv = -dotVectorE3_1.dotVectorE3(eye, v);
    var dn = -dotVectorE3_1.dotVectorE3(eye, n);
    var x = dotVectorE3_1.dotVectorE3(X, u) + du;
    var y = dotVectorE3_1.dotVectorE3(X, v) + dv;
    var z = dotVectorE3_1.dotVectorE3(X, n) + dn;
