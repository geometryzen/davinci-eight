...
exports.RevolutionSimplexPrimitivesBuilder = void 0;
    ...
    RevolutionSimplexPrimitivesBuilder.prototype.revolve = function (points, generator, segments, phiStart, phiLength, attitude) {
        ...
        for (i = 0, il = segments; i < il; i++) {
            for (j = 0, jl = points.length - 1; j < jl; j++) {
                ...
                this.triangle([vertices[d], vertices[b], vertices[a]], [], [new Vector2_1.Vector2([u0, v0]), new Vector2_1.Vector2([u1, v0]), new Vector2_1.Vector2([u0, v1])]);
                this.triangle([vertices[d], vertices[c], vertices[b]], [], [new Vector2_1.Vector2([u1, v0]), new Vector2_1.Vector2([u1, v1]), new Vector2_1.Vector2([u0, v1])]);
            }
        }
...
exports.RevolutionSimplexPrimitivesBuilder = RevolutionSimplexPrimitivesBuilder;
