...
var Texture = (function (_super) {
    ...
    Texture.prototype.destructor = function (levelUp) {
        ...
        mustBeUndefined_1.mustBeUndefined(this.getLoggingName(), this._texture);
    };
    ...
    Object.defineProperty(Texture.prototype, "minFilter", {
        ...
        set: function (filter) {
            if (this.gl) {
                this.bind();
                this.gl.texParameteri(this._target, TextureParameterName_1.TextureParameterName.TEXTURE_MIN_FILTER, filter);
                this.unbind();
            }
            else {
    ...
    Object.defineProperty(Texture.prototype, "magFilter", {
        ...
        set: function (filter) {
            if (this.gl) {
                this.bind();
                this.gl.texParameteri(this._target, TextureParameterName_1.TextureParameterName.TEXTURE_MAG_FILTER, filter);
                this.unbind();
            }
            else {
    ...
    Object.defineProperty(Texture.prototype, "wrapS", {
        ...
        set: function (mode) {
            if (this.gl) {
                this.bind();
                this.gl.texParameteri(this._target, TextureParameterName_1.TextureParameterName.TEXTURE_WRAP_S, mode);
                this.unbind();
            }
            else {
    ...
    Object.defineProperty(Texture.prototype, "wrapT", {
        ...
        set: function (mode) {
            if (this.gl) {
                this.bind();
                this.gl.texParameteri(this._target, TextureParameterName_1.TextureParameterName.TEXTURE_WRAP_T, mode);
                this.unbind();
            }
            else {
