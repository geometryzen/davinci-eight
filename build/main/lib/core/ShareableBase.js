...
var ShareableBase = (function () {
    ...
    function ShareableBase() {
         ...
         */
        this._uuid = uuid4_1.uuid4().generate();
        this._type = 'ShareableBase';
        this._levelUp = 0;
        this._refCount = 1;
        refChange_1.refChange(this._uuid, this._type, +1);
    }
    /**
     * Experimental
     *
    ...
    ShareableBase.prototype.destructor = function (levelUp, grumble) {
        if (grumble === void 0) { grumble = false; }
        mustBeInteger_1.mustBeInteger('levelUp', levelUp);
        mustBeEQ_1.mustBeEQ(this._type + " constructor-destructor chain mismatch: destructor index " + levelUp, levelUp, this._levelUp);
        if (grumble) {
    ...
    ShareableBase.prototype.setLoggingName = function (name) {
        this._type = mustBeString_1.mustBeString('name', name);
        this._levelUp += 1;
        // Update the name used by the reference count tracking.
        refChange_1.refChange(this._uuid, name, +1);
        refChange_1.refChange(this._uuid, name, -1);
    };
    /**
     * <p>
    ...
    ShareableBase.prototype.release = function () {
        ...
        if (refCount === 0) {
            ...
            // this._type = void 0
            // this._uuid = void 0
            if (isDefined_1.isDefined(this._levelUp)) {
