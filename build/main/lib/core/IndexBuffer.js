...
var IndexBuffer = (function (_super) {
    ...
    IndexBuffer.prototype.upload = function () {
        ...
        if (gl) {
            if (this.webGLBuffer) {
                if (this.data) {
                    gl.bufferData(BufferObjects_1.BufferObjects.ELEMENT_ARRAY_BUFFER, this.data, this.usage);
                }
            }
        }
    };
    ...
    IndexBuffer.prototype.bind = function () {
        var gl = this.gl;
        if (gl) {
            gl.bindBuffer(BufferObjects_1.BufferObjects.ELEMENT_ARRAY_BUFFER, this.webGLBuffer);
        }
    };
    IndexBuffer.prototype.unbind = function () {
        var gl = this.gl;
        if (gl) {
            gl.bindBuffer(BufferObjects_1.BufferObjects.ELEMENT_ARRAY_BUFFER, null);
        }
    };
    return IndexBuffer;
