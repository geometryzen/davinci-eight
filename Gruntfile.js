  ...
  grunt.initConfig({
    ...
    tslint: {
      src: [
        ...
        "src/davinci-eight/core/IBufferGeometry.ts",
        "src/davinci-eight/core/IComposite.ts",
        "src/davinci-eight/core/IContextConsumer.ts",
        "src/davinci-eight/core/IContextMonitor.ts",
        ...
        "src/davinci-eight/core/ShareableContextListener.ts",
        "src/davinci-eight/core/ShareableWebGLBuffer.ts",
        "src/davinci-eight/core/ShareableWebGLProgram.ts",
        "src/davinci-eight/core/ShareableWebGLShader.ts",
        "src/davinci-eight/core/ShareableWebGLTexture.ts",
        ...
        "src/davinci-eight/geometries/BoxGeometry.ts",
        "src/davinci-eight/geometries/CylinderSimplexGeometry.ts",
        "src/davinci-eight/geometries/IPrimitivesBuilder.ts",
        "src/davinci-eight/geometries/PrimitivesBuilder.ts",
        "src/davinci-eight/geometries/SimplexGeometry.ts",
        "src/davinci-eight/geometries/SliceSimplexGeometry.ts",

        "src/davinci-eight/materials/GraphicsProgramBuilder.ts",
        "src/davinci-eight/materials/HTMLScriptsGraphicsProgram.ts",
        "src/davinci-eight/materials/LineMaterial.ts",
        "src/davinci-eight/materials/MeshLambertMaterial.ts",
        "src/davinci-eight/materials/MeshMaterial.ts",
        "src/davinci-eight/materials/PointMaterial.ts",
        "src/davinci-eight/materials/SmartGraphicsProgram.ts",
        ...
        "src/davinci-eight/programs/ShareableWebGLProgram.ts",
        ...
        "src/davinci-eight/scene/Mesh.ts",
        "src/davinci-eight/scene/IDrawList.ts",
        "src/davinci-eight/scene/PrimitiveBuffer.ts",
        "src/davinci-eight/scene/Scene.ts",
        "src/davinci-eight/scene/ShareableWebGLBuffers.ts",
        "src/davinci-eight/scene/WebGLRenderer.ts",
        "src/davinci-eight/scene/initWebGL.ts",
        ...
        "src/davinci-eight/visual/Ball.ts",
        "src/davinci-eight/visual/Box.ts",
        "src/davinci-eight/visual/RigidBody.ts",
        "src/davinci-eight/visual/Rod.ts",
