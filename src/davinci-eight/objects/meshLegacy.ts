...
import geometryConstructor = require('davinci-eight/geometries/geometry');
...
var mesh = function(geometry?: Geometry, material?: Material): Mesh {
    ...
    var publicAPI = {
        ...
        contextFree: function() {
          // TODO: Check to see if we have already been called.
          gl.deleteShader(_vs);
          gl.deleteShader(_fs);
          gl.deleteProgram(_program);
          // TODO: free buffers.
          publicAPI.contextLoss();
        },
        contextGain: function(context: WebGLRenderingContext, contextGainId: string) {
            var infoLog: string;
            gl = context;
        ...
        updateMatrix: function() {
            ...
            var v = glMatrix.vec3.fromValues(base.position.x, base.position.y, base.position.z);
            var q = glMatrix.quat.fromValues(base.attitude.yz, base.attitude.zx, base.attitude.xy, base.attitude.w);
            /*
        ...
        draw(drawContext: DrawContext, camera: Camera) {

        },
        drawLegacy: function(projectionMatrix: number[]) {
            if (gl) {
                gl.useProgram(_program);

                publicAPI.updateMatrix();
