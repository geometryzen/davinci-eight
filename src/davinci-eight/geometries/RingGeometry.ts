 ...
 * 
 */
function computeVertices(a: number, b: number, n: Cartesian3, s: Cartesian3, angle: number, generator: Spinor3Coords, radialSegments: number, thetaSegments: number, vertices: Vector3[], uvs: Vector2[]) {
    /**
...
function makeTriangles(vertices: Vector3[], uvs: Vector2[], normal: Vector3, radialSegments: number, thetaSegments: number, data: Simplex[]) {
...
class RingGeometry extends Geometry {
     ...
     * @param 
     */
    constructor(innerRadius: number = 0, outerRadius: number = 1, normal: Cartesian3 = Vector3.e3, start: Cartesian3 = Vector3.e1, angle: number = 2 * Math.PI) {
        super('RingGeometry')
    ...
    public regenerate(): void {
        ...
        var generator: Spinor3Coords = new Spinor3().dual(this.normal)
