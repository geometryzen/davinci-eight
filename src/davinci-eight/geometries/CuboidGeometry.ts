...
function side(basis: MutableVectorE3[], uSegments: number, vSegments: number): GridTopology {
...
class CuboidGeometry extends Geometry implements IGeometry<CuboidGeometry> {
    ...
    private _a: MutableVectorE3 = MutableVectorE3.copy(Euclidean3.e1);
    private _b: MutableVectorE3 = MutableVectorE3.copy(Euclidean3.e2);
    private _c: MutableVectorE3 = MutableVectorE3.copy(Euclidean3.e3);
