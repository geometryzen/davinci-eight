...
export default class ArrowBuilder extends AxialPrimitivesBuilder implements GeometryBuilder {
   ...
   * @class ArrowBuilder
   * @constructor
   * @param axis {VectorE3} The direction of the arrow. The argument is normalized to a unit vector.
   * @param cutLine {VectorE3} The direction of the start of the arrow slice. The argument is normalized to a unit vector.
   * @param clockwise {boolean} The orientation
   */
