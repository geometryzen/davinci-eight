 ...
 */
export default class SphereGeometry extends SliceSimplexGeometry implements IAxialGeometry<SphereGeometry> {
    /**
     * @property _radius
     * @type {R1}
     * @private
     ...
     * @chainable
     */
    public setAxis(axis: VectorE3): SphereGeometry {
        super.setAxis(axis)
        return this
    }
    /**
     ...
     * @chainable
     */
    public setPosition(position: VectorE3): SphereGeometry {
        super.setPosition(position)
        return this
    }
    public enableTextureCoords(enable: boolean): SphereGeometry {
     ...
     * @chainable
     */
    public setModified(modified: boolean): SphereGeometry {
