 ...
 */
export default function(attributes: { [name: string]: AttribMetaInfo }, uniforms: { [name: string]: UniformMetaInfo }, vColor: boolean, vLight: boolean) {
  ...
  const lines: string[] = []
  lines.push(`// fragment shader generated by ${core.NAMESPACE} ${core.VERSION}`)
