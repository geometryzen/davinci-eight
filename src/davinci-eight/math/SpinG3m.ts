 ...
 */
export default class SpinG3m extends VectorN<number> implements SpinorE3, Mutable<number[]>, MutableGeometricElement3D<SpinorE3, SpinG3m, SpinG3m, VectorE3> {
    /**
     * Constructs a <code>SpinG3m</code> from a <code>number[]</code>.
     ...
     * @param [α = 1] {number}
     * @return {SpinG3m} <code>this</code>
     * @chainable
     */
    add(spinor: SpinorE3, α = 1): SpinG3m {
    ...
    /**
     * @method clone
     * @return {SpinG3m} A copy of <code>this</code>.
     * @chainable
     */
    clone(): SpinG3m {
     ...
     * Intentionally undocumented.
     */
    copyVector(vector: VectorE3): SpinG3m {
        return this.zero()
    }
    ...
    lco(rhs: SpinorE3): SpinG3m {
        return this.lco2(this, rhs)
    }

    lco2(a: SpinorE3, b: SpinorE3): SpinG3m {
     ...
     * @chainable
     */
    lerp2(a: SpinorE3, b: SpinorE3, α: number): SpinG3m {
    ...
    /**
     * @method squaredNorm
     * @return {SpinG3m} <code>this * conj(this)</code>
     * @chainable
     */
    squaredNorm(): SpinG3m {
    ...
    rco(rhs: SpinorE3): SpinG3m {
        return this.rco2(this, rhs)
    }

    rco2(a: SpinorE3, b: SpinorE3): SpinG3m {
        // FIXME: How to leverage? Maybe break up? Don't want performance hit.
        // scpG3(a, b, this)
        return this
    }
     ...
     * @return {SpinG3m} <code>this</code> The rotor representing a rotation from a to b.
     * @chainable
     */
    ...
    scp(rhs: SpinorE3): SpinG3m {
        return this.scp2(this, rhs)
    }
    scp2(a: SpinorE3, b: SpinorE3): SpinG3m {
        // FIXME: How to leverage? Maybe break up? Don't want performance hit.
        // scpG3(a, b, this)
        return this
    }
    ...
    slerp(target: SpinorE3, α: number): SpinG3m {
        var R2m = SpinG3m.copy(target)
        var R1m = this.clone()
        var R = R2m.mul(R1m.inv())
        R.log()
     ...
     * <code>this ⟼ a * b</code>
     * </p>
     * Sets this SpinG3m to the geometric product a * b of the vector arguments. 
     * @method spinor
     * @param a {VectorE3}
     * @param b {VectorE3}
     * @return {SpinG3m}
    ...
    ext(rhs: SpinorE3): SpinG3m {
        return this.ext2(this, rhs)
    }
    ext2(a: SpinorE3, b: SpinorE3): SpinG3m {
        // FIXME: How to leverage? Maybe break up? Don't want performance hit.
        // scpG3(a, b, this)
        return this
    }
     ...
     * @method copy
     * @param spinor {SpinorE3}
     * @return {SpinG3m} A copy of the <code>spinor</code> argument.
     * @static
     */
    static copy(spinor: SpinorE3): SpinG3m {
     ...
     * @return {SpinG3m}
     */
    static dual(v: VectorE3): SpinG3m {
     ...
     * @param b {SpinorE3}
     * @param α {number}
     * @return {SpinG3m} <code>a + α * (b - a)</code>
     * @static
     */
    static lerp(a: SpinorE3, b: SpinorE3, α: number): SpinG3m {
     ...
     * @static
     */
    static rotorFromDirections(a: VectorE3, b: VectorE3): SpinG3m {
