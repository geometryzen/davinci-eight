 ...
 */
class MutableSpinorE3 extends VectorN<number> implements SpinorE3, Mutable<number[]>, MutableGeometricElement<SpinorE3, MutableSpinorE3, MutableSpinorE3, VectorE3, VectorE3>
{
  /**
   * @class MutableSpinorE3
   * @constructor
