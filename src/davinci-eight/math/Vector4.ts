 ...
 * @class Vector4
 */
export default class Vector4 extends VectorN<number> implements ColumnVector<Matrix4, Vector4>, VectorE4, MutableLinearElement<VectorE4, Vector4, SpinorE4, VectorE4> {
