...
import add3x3 = require('../math/add3x3')
 ...
 */
class Mat3R extends AbstractMatrix<Mat3R> implements Matrix<Mat3R, VectorE3, VectorE2>, Ring<Mat3R>, RingOperators<Mat3R> {
  /**
   ...
   * @chainable
   */
  public static reflection(n: VectorE2): Mat3R {
