 ...
 * @class R1m
 */
export default class R1m extends VectorN<number> implements VectorE1, MutableLinearElement<VectorE1, R1m, SpinorE1, VectorE1>, Matrix<R1m, VectorE1, VectorE0> {
    /**
     * @class R1m
     * @constructor
    ...
    sub2(a: VectorE1, b: VectorE1): R1m {
        this.x = a.x - b.x
        return this
    }
    /**
     * @method neg
     * @return {R1m} <code>this</code>
     */
    neg() {
        this.x = -this.x
        return this
    ...
    reflect(n: VectorE1): R1m {
        // FIXME: TODO
        return this;
    }
    reflection(n: VectorE0): R1m {
        // FIXME: TODO
        return this;
    }

    rotate(rotor: SpinorE1): R1m {
        return this;
    }
