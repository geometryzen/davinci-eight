 ...
 */
export default class R3m extends VectorN<number> implements ColumnVector<Mat3R, R3m>, VectorE3, MutableLinearElement<VectorE3, R3m, SpinorE3, VectorE3> {
    ...
    /**
     * @method clone
     * @return {R3m} <code>copy(this)</code>
     */
    clone() {
    ...
    /**
     * Copies the coordinate values into this <code>R3m</code>.
     ...
     * @static
     */
    static vector(x: number, y: number, z: number, uom?: Unit): R3m {
        const v = new R3m([x, y, z])
        v.uom = uom
        return v
    }
}
