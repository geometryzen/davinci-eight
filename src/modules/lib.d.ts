...
/**
  ...
  * different typed arrays. VertexBuffers cannot be read from or written to directly, 
  * but can be passed to a typed array or DataView Object to interpret the raw 
  * buffer as needed. 
  */
interface VertexBuffer {
    /**
      * Read-only. The length of the VertexBuffer (in bytes).
      */
    byteLength: number;
}

declare var VertexBuffer: {
    prototype: VertexBuffer;
    new (byteLength: number): VertexBuffer;
}
...
/**
  ...
  */
interface Int8Array extends VertexBufferView {
    /**
    ...
    /**
      * Gets a new Int8Array view of the VertexBuffer store for this array, referencing the elements at begin, inclusive, up to end, exclusive. 
...
declare var Int8Array: {
    ...
    new (buffer: VertexBuffer, byteOffset?: number, length?: number): Int8Array;
    BYTES_PER_ELEMENT: number;
}
...
/**
  ...
  */
interface Uint8Array extends VertexBufferView {
    /**
      * The size in bytes of each element in the array. 
      */
    BYTES_PER_ELEMENT: number;
    ...
    /**
      * Gets a new Uint8Array view of the VertexBuffer Object store for this array, specifying the first and last members of the subarray. 
      * @param begin The index of the beginning of the array.
      * @param end The index of the end of the array.
      */
...
declare var Uint8Array: {
    ...
    new (buffer: VertexBuffer, byteOffset?: number, length?: number): Uint8Array;
    BYTES_PER_ELEMENT: number;
}
...
/**
  ...
  */
interface Int16Array extends VertexBufferView {
    /**
      * The size in bytes of each element in the array. 
      */
    BYTES_PER_ELEMENT: number;
    ...
    /**
      * Gets a new Int16Array view of the VertexBuffer Object store for this array, specifying the first and last members of the subarray. 
      * @param begin The index of the beginning of the array.
      * @param end The index of the end of the array.
      */
...
declare var Int16Array: {
    ...
    new (buffer: VertexBuffer, byteOffset?: number, length?: number): Int16Array;
    BYTES_PER_ELEMENT: number;
}
...
/**
  ...
  */
interface Uint16Array extends VertexBufferView {
    /**
      * The size in bytes of each element in the array. 
      */
    BYTES_PER_ELEMENT: number;
    ...
    /**
      * Gets a new Uint16Array view of the VertexBuffer Object store for this array, specifying the first and last members of the subarray.
      * @param begin The index of the beginning of the array.
      * @param end The index of the end of the array.
      */
...
declare var Uint16Array: {
    ...
    new (buffer: VertexBuffer, byteOffset?: number, length?: number): Uint16Array;
    BYTES_PER_ELEMENT: number;
}
...
/**
  ...
  */
interface Int32Array extends VertexBufferView {
    /**
      * The size in bytes of each element in the array. 
      */
    BYTES_PER_ELEMENT: number;
    ...
    /**
      * Gets a new Int32Array view of the VertexBuffer Object store for this array, specifying the first and last members of the subarray. 
      * @param begin The index of the beginning of the array.
      * @param end The index of the end of the array.
      */
...
declare var Int32Array: {
    ...
    new (buffer: VertexBuffer, byteOffset?: number, length?: number): Int32Array;
    BYTES_PER_ELEMENT: number;
}
...
/**
  ...
  */
interface Uint32Array extends VertexBufferView {
    /**
      * The size in bytes of each element in the array. 
      */
    BYTES_PER_ELEMENT: number;
    ...
    /**
      * Gets a new Int8Array view of the VertexBuffer Object store for this array, specifying the first and last members of the subarray. 
      * @param begin The index of the beginning of the array.
      * @param end The index of the end of the array.
      */
...
declare var Uint32Array: {
    ...
    new (buffer: VertexBuffer, byteOffset?: number, length?: number): Uint32Array;
    BYTES_PER_ELEMENT: number;
}
...
/**
  ...
  */
interface Float32Array extends VertexBufferView {
    /**
      * The size in bytes of each element in the array. 
      */
    BYTES_PER_ELEMENT: number;
    ...
    /**
      * Gets a new Float32Array view of the VertexBuffer Object store for this array, specifying the first and last members of the subarray. 
      * @param begin The index of the beginning of the array.
      * @param end The index of the end of the array.
      */
...
declare var Float32Array: {
    ...
    new (buffer: VertexBuffer, byteOffset?: number, length?: number): Float32Array;
    BYTES_PER_ELEMENT: number;
}
...
/**
  ...
  */
interface Float64Array extends VertexBufferView {
    /**
      * The size in bytes of each element in the array. 
      */
    BYTES_PER_ELEMENT: number;
    ...
    /**
      * Gets a new Float64Array view of the VertexBuffer Object store for this array, specifying the first and last members of the subarray. 
      * @param begin The index of the beginning of the array.
      * @param end The index of the end of the array.
      */
...
declare var Float64Array: {
    ...
    new (buffer: VertexBuffer, byteOffset?: number, length?: number): Float64Array;
    BYTES_PER_ELEMENT: number;
}

/**
  * You can use a DataView object to read and write the different kinds of binary data to any location in the VertexBuffer. 
  */
interface DataView extends VertexBufferView {
    /**
...
declare var DataView: {
    prototype: DataView;
    new (buffer: VertexBuffer, byteOffset?: number, length?: number): DataView;
}
...
interface MSStreamReader extends MSBaseReader {
    error: DOMError;
    readAsVertexBuffer(stream: MSStream, size?: number): void;
...
interface FileReader extends MSBaseReader {
    error: DOMError;
    readAsVertexBuffer(blob: Blob): void;
...
interface SubtleCrypto {
    unwrapKey(wrappedKey: VertexBufferView, keyAlgorithm: any, keyEncryptionKey: Key, extractable?: boolean, keyUsages?: string[]): KeyOperation;
    encrypt(algorithm: any, key: Key, buffer?: VertexBufferView): CryptoOperation;
    importKey(format: string, keyData: VertexBufferView, algorithm: any, extractable?: boolean, keyUsages?: string[]): KeyOperation;
    wrapKey(key: Key, keyEncryptionKey: Key, keyWrappingAlgorithm: any): KeyOperation;
    verify(algorithm: any, key: Key, signature: VertexBufferView, buffer?: VertexBufferView): CryptoOperation;
    deriveKey(algorithm: any, baseKey: Key, derivedKeyType: any, extractable?: boolean, keyUsages?: string[]): KeyOperation;
    digest(algorithm: any, buffer?: VertexBufferView): CryptoOperation;
    exportKey(format: string, key: Key): KeyOperation;
    generateKey(algorithm: any, extractable?: boolean, keyUsages?: string[]): KeyOperation;
    sign(algorithm: any, key: Key, buffer?: VertexBufferView): CryptoOperation;
    decrypt(algorithm: any, key: Key, buffer?: VertexBufferView): CryptoOperation;
}
...
interface RandomSource {
    getRandomValues(array: VertexBufferView): VertexBufferView;
}
...
interface SourceBuffer extends EventTarget {
    ...
    audioTracks: AudioTrackList;
    appendBuffer(data: VertexBuffer): void;
...
interface CryptoOperation extends EventTarget {
    ...
    abort(): void;
    finish(): void;
    process(buffer: VertexBufferView): void;
}
...
interface WebGLRenderingContext {
    ...
    bufferData(target: number, data: VertexBufferView, usage: number): void;
    bufferData(target: number, data: VertexBuffer, usage: number): void;
    ...
    bufferSubData(target: number, offset: number, data: VertexBuffer): void;
    bufferSubData(target: number, offset: number, data: VertexBufferView): void;
    ...
    compressedTexImage2D(target: number, level: number, internalformat: number, width: number, height: number, border: number, data: VertexBufferView): void;
    ...
    texImage2D(target: number, level: number, internalformat: number, width: number, height: number, border: number, format: number, type: number, pixels: VertexBufferView): void;
    ...
    texSubImage2D(target: number, level: number, xoffset: number, yoffset: number, width: number, height: number, format: number, type: number, pixels: VertexBufferView): void;
    ...
    compressedTexSubImage2D(target: number, level: number, xoffset: number, yoffset: number, width: number, height: number, format: number, data: VertexBufferView): void;
    ...
    readPixels(x: number, y: number, width: number, height: number, format: number, type: number, pixels: VertexBufferView): void;
