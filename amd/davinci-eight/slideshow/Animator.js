...
define(["require", "exports", '../slideshow/animations/Delay', '../utils/Shareable', '../utils/StringIUnknownMap', '../utils/IUnknownArray'], function (require, exports, Delay, Shareable, StringIUnknownMap, IUnknownArray) {
    var Clock = (function () {
        function Clock() {
            this.now = 1;
        }
