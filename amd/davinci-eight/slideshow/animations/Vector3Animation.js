...
define(["require", "exports", '../../core/Shareable', '../../math/R3m'], function (require, exports, Shareable_1, R3m_1) {
    ...
    var Vector3Animation = (function (_super) {
        ...
        function Vector3Animation(value, duration, callback, ease) {
            ...
            this.to = R3m_1.default.copy(value);
        ...
        Vector3Animation.prototype.apply = function (target, propName, now, offset) {
            if (!this.start) {
                ...
                if (this.from === void 0) {
                    ...
                    if (data) {
                        this.from = new R3m_1.default().copyCoordinates(data);
                    }
                }
            }
            var ease = this.ease;
            ...
            var lerp = R3m_1.default.lerp(this.from, this.to, rolloff);
