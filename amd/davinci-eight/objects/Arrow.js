define(["require", "exports", '../mesh/CylinderBuilder', '../objects/drawableModel', '../programs/smartProgram', '../uniforms/Node'], function (require, exports, CylinderBuilder, drawableModel, smartProgram, Node) {
    var Arrow = (function () {
