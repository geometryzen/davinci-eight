...
[
  ...
  'davinci-eight/dfx/triangleElementsFromSimplex3s',
  'davinci-eight/dfx/Elements',
  'davinci-eight/core/Symbolic'
],
function(Simplex3, Simplex3Vertex, Vector3, triangleElementsFromSimplex3s, Elements, Symbolic)
{
  ...
  describe("triangleElementsFromSimplex3s", function() {
    describe("zero triangles", function() {
      it("should create empty arrays", function() {
        ...
        var elements = triangleElementsFromSimplex3s(faces, attribMap);
    ...
    describe("two triangles with one common edge", function() {
      ...
      var f012 = new Simplex3(vec0, vec1, vec2);
      var f023 = new Simplex3(vec0, vec2, vec3);
      var faces = [];
      faces.push(f012);
      faces.push(f023);
      var attribMap = {};
    ...
    describe("tetrahedron", function() {
      ...
      var f123 = new Simplex3(vecs[1], vecs[2], vecs[3]);
      var f013 = new Simplex3(vecs[0], vecs[1], vecs[3]);
      var f032 = new Simplex3(vecs[0], vecs[3], vecs[2]);
      var f021 = new Simplex3(vecs[0], vecs[2], vecs[1]);
      var faces = [];
      faces.push(f123);
      faces.push(f013);
      faces.push(f032);
