...
[
  ...
  'davinci-eight/dfx/boxSimplex3s',
  'davinci-eight/dfx/Elements',
  'davinci-eight/core/Symbolic'
],
function(Simplex3, Simplex3Vertex, Vector3, triangleElementsFromSimplex3s, boxSimplex3s, Elements, Symbolic)
{
  ...
  var TEX_COORDS_PER_VERTEX = 2;
    ...
    //  |/      |/
    //  v2------v3
  describe("boxSimplex3s", function() {
    describe("everyting", function() {
      var faces = boxSimplex3s();
      var attribMap = {};
